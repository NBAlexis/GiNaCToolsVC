...
#define DO_BINOP_TESTGCD(typename,type,rtype,opname)  \
...
DO_BINOP_TESTGCD(integer,cl_I,cl_I,gcd)

void test_gcd (int &er, int &done)
{
	test_integer_gcd(er, done);
}

void test_xgcd (int &er, int &done)
{
	{
		cl_I a = 77874422;
		cl_I b = 32223899;
	...
	}
	{
        ...
        ASSERTGCD(g == 1);
        ASSERTGCD(g == a*u+b*v);
        ASSERTGCD(u == 77165803);
        ASSERTGCD(v == -138134388);
	}
	{
		cl_I a = "#x80000000";
		cl_I b = "#x-C0000000";
