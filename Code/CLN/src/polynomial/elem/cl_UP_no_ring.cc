...
#ifdef __CLN_MS_VC__
static cl_heap_no_univpoly_ring* cl_heap_no_univpoly_ring_instance = new cl_heap_no_univpoly_ring();
const cl_univpoly_ring cl_no_univpoly_ring = cl_univpoly_ring(cl_heap_no_univpoly_ring_instance);
#else
