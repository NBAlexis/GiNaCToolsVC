// Weak hash tables with 1 key and a value
...
// Requirements:
// - same as for hash1,
// - key1_type must be a subclass of cl_gc[object|pointer],
// - value_type must be a subclass of cl_[gc|rc][object|pointer],
// - function  maygc_htentry(const cl_htentry1<key1_type,value_type>&);
