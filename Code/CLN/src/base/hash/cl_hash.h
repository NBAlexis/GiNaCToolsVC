...
template <class htentry> CLN_TEMPLATE struct _cl_hashtable_iterator;

template <class htentry>
struct CLN_TEMPLATE cl_heap_hashtable : public cl_heap {
...
template <class htentry> CLN_TEMPLATE
