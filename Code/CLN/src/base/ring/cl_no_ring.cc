...
uninitialized_error_msg (const _cl_ring_element& obj)
{
	...
	fprinthexadecimal(buf, (uintP)(void*)&obj);
	fprint(buf, ": 0x");
        fprinthexadecimal(buf, (uintP)obj.rep.word);
	return buf.str();
}
...
uninitialized_error_msg (const _cl_ring_element& obj_x, const _cl_ring_element& obj_y)
{
	...
	fprinthexadecimal(buf, (uintP)(void*)&obj_x);
	fprint(buf, ": 0x");
        fprinthexadecimal(buf, (uintP)obj_x.rep.word);
	fprint(buf, ", @0x");
	fprinthexadecimal(buf, (uintP)(void*)&obj_y);
	fprint(buf, ": 0x");
        fprinthexadecimal(buf, (uintP)obj_y.rep.word);
	return buf.str();
}
...
#ifdef __CLN_MS_VC__
static cl_heap_no_ring* cl_heap_no_ring_instance = new cl_heap_no_ring();
const cl_ring cl_no_ring(cl_heap_no_ring_instance);
#else
