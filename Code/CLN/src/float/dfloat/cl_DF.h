...
#ifdef __CLN_MS_VC__
extern cl_heap_dfloat* cl_allocate_df0();
#endif

// Double Float 0.0
  extern CLN_API const cl_DF cl_DF_0;
// Double Float 1.0
  extern CLN_API const cl_DF cl_DF_1;
// Double Float -1.0
  extern CLN_API const cl_DF cl_DF_minus1;
...
extern CLN_API const cl_DF cl_I_to_DF (const cl_I& x);

// cl_RA_to_DF(x) wandelt eine rationale Zahl x in ein Double-Float um
// und rundet dabei.
extern CLN_API const cl_DF cl_RA_to_DF (const cl_RA& x);
...
extern CLN_API cl_heap_dfloat* cl_double_to_DF_pointer (const double val);

// cl_DF_to_double(obj,&val);
// wandelt ein Double-Float obj in ein IEEE-Double-Float val um.
extern CLN_API void cl_DF_to_double (const cl_DF& obj, dfloatjanus* val_);
