...
extern CLN_API const cl_FF cl_SF_to_FF (const cl_SF& x);

// cl_SF_to_DF(x) wandelt ein Short-Float x in ein Double-Float um.
extern CLN_API const cl_DF cl_SF_to_DF (const cl_SF& x);
...
extern CLN_API const cl_F cl_F_extendsqrt (const cl_F& x);
...
extern CLN_API const cl_F cl_F_extendsqrtx (const cl_F& x);
...
extern CLN_API const cl_F cl_F_shortenrelative (const cl_F& x, const cl_F& y);
