...
struct CLN_API cl_GV_RA : public cl_GV<cl_RA,cl_GV_R> {
public:
	// Constructors.
    inline cl_GV_RA ();
    inline cl_GV_RA (const cl_GV_RA&);
    inline explicit cl_GV_RA (std::size_t len);
	// Assignment operators.
    inline cl_GV_RA& operator= (const cl_GV_RA&);
	// Private pointer manipulations.
    inline cl_GV_RA (cl_heap_GV_RA* p) : cl_GV<cl_RA,cl_GV_R> (p) {}
    inline cl_GV_RA (cl_private_thing p) : cl_GV<cl_RA,cl_GV_R> (p) {}
};
