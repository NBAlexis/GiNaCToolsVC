...
struct CLN_API cl_print_rational_flags {
...
struct CLN_API cl_print_float_flags {
...
struct CLN_API cl_print_real_flags : cl_print_rational_flags, cl_print_float_flags {};

struct CLN_API cl_print_complex_flags {
...
struct CLN_API cl_print_number_flags : cl_print_real_flags, cl_print_complex_flags {};
...
struct CLN_API cl_print_vector_flags {
...
struct CLN_API cl_print_univpoly_flags {
...
struct CLN_API cl_print_flags : cl_print_number_flags, cl_print_vector_flags, cl_print_univpoly_flags {};
