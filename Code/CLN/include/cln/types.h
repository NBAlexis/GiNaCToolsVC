...
// Elementary arithmetic types of given width:
  ...
  // 64 bits
    ...
    #undef HAVE_LONGLONG
    #ifdef __CLN_MS_VC__
      #error "We shall have HAVE_LONGLONG"
    #endif     
   #endif
  #endif
...
// if CLN is sitting on top of GMP.
    ...
    // (([DO NOT believe it...]))
    // Using 1.3.4, the config.h file is ignroed, forced by cl_config.h.
    // So we have NO GMP_DEMANDS_UINTD_LONG_LONG, while we have GMP!!
    // (===========================)
		#ifdef __CLN_MS_VC__
  		#if !(defined(HAVE_FAST_LONGLONG) && defined(__x86_64__))
    		#error "MinGW64 should have HAVE_FAST_LONGLONG and __x86_64__"
  		#endif
		#endif     
...
// Assumption: cl_word_size >= intPsize
    ...
    #ifdef __CLN_MS_VC__
      #error "We shall have HAVE_FAST_LONGLONG"
    #endif      
  #endif
