...
class CLN_API cl_ring : public cl_rcpointer {
public:
...
class CLN_API _cl_ring_element {
public:
	cl_gcobject rep;	// representation of the element
	// Default constructor.
	_cl_ring_element ();
...
class CLN_API cl_ring_element : public _cl_ring_element {
protected:
	cl_ring _ring;			// ring
public:
...
struct CLN_API _cl_ring_setops {
	// print
...
struct CLN_API _cl_ring_addops {
	// 0
...
struct CLN_API _cl_ring_mulops {
	// 1
...
class CLN_API cl_heap_ring : public cl_heap {
public:
	// Allocation.
	void* operator new (size_t size) { return malloc_hook(size); }
	// Deallocation.
...
extern CLN_API const cl_ring cl_no_ring;
extern CLN_API cl_class cl_class_no_ring;

class CLN_API cl_no_ring_init_helper
{
	static int count;
public:
...
template <class T>
struct CLN_TEMPLATE cl_number_ring_ops {
...
class CLN_API cl_heap_number_ring : public cl_heap_ring {
public:
...
class CLN_API cl_number_ring : public cl_ring {
public:
...
template <class T>
class CLN_TEMPLATE cl_specialized_number_ring : public cl_number_ring {
public:
