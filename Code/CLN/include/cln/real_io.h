...
extern CLN_API const cl_R read_real (const cl_read_flags& flags, const char * string, const char * string_limit, const char * * end_of_parse);
extern CLN_API const cl_R read_real (std::istream& stream, const cl_read_flags& flags);

// Documented input functions
extern CLN_API cl_read_flags cl_R_read_flags;
...
extern CLN_API void print_real (std::ostream& stream, const cl_print_flags& flags, const cl_R& z);
extern CLN_API void print_real (std::ostream& stream, const cl_print_number_flags& flags, const cl_R& z);
extern CLN_API void print_real (std::ostream& stream, const cl_print_real_flags& flags, const cl_R& z);
