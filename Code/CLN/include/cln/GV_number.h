...
struct CLN_API cl_GV_number : public cl_GV<cl_number,cl_GV_any> {
public:
	// Constructors.
	inline cl_GV_number ();
    inline cl_GV_number (const cl_GV_number&);
    inline explicit cl_GV_number (std::size_t len);
	// Assignment operators.
    inline cl_GV_number& operator= (const cl_GV_number&);
	// Private pointer manipulations.
    inline cl_GV_number (cl_heap_GV_number* p) : cl_GV<cl_number,cl_GV_any> (p) {}
    inline cl_GV_number (cl_private_thing p) : cl_GV<cl_number,cl_GV_any> (p) {}
};
...
extern CLN_API cl_heap_GV_number* cl_make_heap_GV_number (std::size_t len);
...
extern CLN_API const cl_GV_number cl_null_GV_number;
inline cl_GV_number::cl_GV_number ()
	: cl_GV<cl_number,cl_GV_any> ((cl_heap_GV_number*) cl_null_GV_number) {}
class CLN_API cl_GV_number_init_helper
{
	static int count;
public:
    inline cl_GV_number_init_helper();
    inline ~cl_GV_number_init_helper();
};
static cl_GV_number_init_helper cl_GV_number_init_helper_instance;

// Copy a vector.
extern CLN_API const cl_GV_number copy (const cl_GV_number&);
