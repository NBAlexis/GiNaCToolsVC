...
extern CLN_API uint32 random32 (random_state& randomstate);
...
extern CLN_API random_state default_random_state;
class CLN_API cl_random_def_init_helper
{
	static int count;
public:
