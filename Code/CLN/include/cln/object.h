...
// Number of bits reserved for tagging information:
  ...
  #define cl_tag_len	2 //2 in __CLN_MS_VC__
#else
  #define cl_tag_len	3
#endif
#define cl_tag_shift	0
#define cl_value_shift  (cl_tag_len+cl_tag_shift)
#define cl_value_len	(cl_pointer_size - cl_value_shift) //62 in __CLN_MS_VC__
#define cl_tag_mask	(((1ULL << cl_tag_len) - 1) << cl_tag_shift)
#define cl_value_mask	(((1ULL << cl_value_len) - 1) << cl_value_shift)
...
#ifdef __CLN_MS_VC__
//this will cause incomplete type is not allowed because cl_anything is undefined
//C4430 missing type specifier
//union cl_anything { void* p; cl_uint v;  };
struct CLN_API cl_anything {};
typedef cl_anything * cl_private_thing;
#else
