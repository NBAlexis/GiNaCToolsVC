...
class CLN_API cl_modint_ring : public cl_ring {
public:
	// Default constructor.
	cl_modint_ring ();
...
// Z/0Z
extern CLN_API const cl_modint_ring cl_modint0_ring;
...
class CLN_API cl_MI_init_helper
{
	static int count;
public:
	cl_MI_init_helper();
...
struct CLN_API cl_composite_condition : public cl_condition {
...
class CLN_API _cl_MI /* cf. _cl_ring_element */ {
public:
...
class CLN_API cl_MI /* cf. cl_ring_element */ : public _cl_MI {
protected:
...
struct CLN_API _cl_modint_setops /* cf. _cl_ring_setops */ {
	// print
...
struct CLN_API _cl_modint_addops /* cf. _cl_ring_addops */ {
	// 0
...
struct CLN_API _cl_modint_mulops /* cf. _cl_ring_mulops */ {
	// 1
...
class CLN_API cl_heap_modint_ring /* cf. cl_heap_ring */ : public cl_heap {
...
extern CLN_API const cl_modint_ring find_modint_ring (const cl_I& m);
