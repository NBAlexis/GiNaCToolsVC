...
template <class T> class CLN_TEMPLATE cl_SV_inner;

template <class T>
class CLN_TEMPLATE cl_SV_inner {
protected:
...
template <class T>
struct CLN_TEMPLATE cl_heap_SV : cl_heap {
	cl_SV_inner<T> v;
	// here room for the elements
};

template <class T, class BASE>
struct CLN_TEMPLATE cl_SV : public BASE {
public:
	// Length.
...
#endif
	// Constructors.
    inline cl_SV (const cl_SV&);
	// Assignment operators.
    inline cl_SV& operator= (const cl_SV&);
