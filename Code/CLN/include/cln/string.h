...
struct CLN_API cl_heap_string : public cl_heap {
private:
...
struct CLN_API cl_string : public cl_gcpointer {
public:
...
// Hash code.
extern CLN_API unsigned long hashcode (const cl_string& str);

// Output.
extern CLN_API void fprint (std::ostream& stream, const cl_string& str);
...
extern CLN_API const cl_string cl_fget (std::istream& stream, char delim = '\n');

// Reads a line. Up to delim. The delimiter character is not placed in the
// resulting string. The delimiter character is extracted from the input stream.
// If EOF is encountered, the stream's eofbit is set.
extern CLN_API const cl_string cl_fgetline (std::istream& stream, char delim = '\n');
...
extern CLN_API const cl_string cl_fget (std::istream& stream, int n, char delim = '\n');
extern CLN_API const cl_string cl_fgetline (std::istream& stream, int n, char delim = '\n');
...
// If EOF is encountered, the stream's eofbit is set.
extern CLN_API std::istream& operator>> (std::istream& stream, cl_string& str);

// Runtime typing support.
extern CLN_API cl_class cl_class_string;
