...
// < ergebnis: der Wert des Integer als 32-Bit-Zahl.
  extern CLN_API uint32 cl_I_to_UL (const cl_I& obj);
...
// < ergebnis: der Wert des Integer als 32-Bit-Zahl.
  extern CLN_API sint32 cl_I_to_L (const cl_I& obj);
...
#ifdef intQsize
 extern CLN_API uint64 cl_I_to_UQ (const cl_I& obj);
 extern CLN_API sint64 cl_I_to_Q (const cl_I& obj);
#endif
...
// Ergebnis Integer.
extern CLN_API const cl_I logior (const cl_I& x, const cl_I& y);

// (LOGXOR x y), wenn x, y Integers sind.
// Ergebnis Integer.
extern CLN_API const cl_I logxor (const cl_I& x, const cl_I& y);

// (LOGAND x y), wenn x, y Integers sind.
// Ergebnis Integer.
extern CLN_API const cl_I logand (const cl_I& x, const cl_I& y);

// (LOGEQV x y), wenn x, y Integers sind.
// Ergebnis Integer.
extern CLN_API const cl_I logeqv (const cl_I& x, const cl_I& y);

// (LOGNAND x y), wenn x, y Integers sind.
// Ergebnis Integer.
extern CLN_API const cl_I lognand (const cl_I& x, const cl_I& y);

// (LOGNOR x y), wenn x, y Integers sind.
// Ergebnis Integer.
extern CLN_API const cl_I lognor (const cl_I& x, const cl_I& y);

// (LOGANDC2 x y), wenn x, y Integers sind.
// Ergebnis Integer.
extern CLN_API const cl_I logandc2 (const cl_I& x, const cl_I& y);
...
// Ergebnis Integer.
extern CLN_API const cl_I logorc2 (const cl_I& x, const cl_I& y);
...
// Ergebnis Integer.
extern CLN_API const cl_I lognot (const cl_I& x);
...
// Ergebnis Integer.
extern CLN_API const cl_I boole (cl_boole op, const cl_I& x, const cl_I& y);

// Prüft, ob (LOGTEST x y), wo x und y Integers sind.
// (LOGTEST x y) = (NOT (ZEROP (LOGAND x y))).
// < ergebnis: /=0, falls ja; =0, falls nein.
extern CLN_API bool logtest (const cl_I& x, const cl_I& y);

// Prüft, ob (LOGBITP x y), wo x und y Integers sind.
// Ergebnis: /=0, wenn ja; =0, wenn nein.
extern CLN_API bool logbitp (uintC x, const cl_I& y);
extern CLN_API bool logbitp (const cl_I& x, const cl_I& y);

// Prüft, ob (ODDP x), wo x ein Integer ist.
// Ergebnis: /=0, falls ja; =0, falls nein.
extern CLN_API bool oddp (const cl_I& x);
...
extern CLN_API const cl_I ash (const cl_I& x, sintC y);
extern CLN_API const cl_I ash (const cl_I& x, const cl_I& y);
...
extern CLN_API const cl_I plus1 (const cl_I& x);

// (1- x), wo x ein Integer ist. Ergebnis Integer.
extern CLN_API const cl_I minus1 (const cl_I& x);

// (+ x y), wo x und y Integers sind. Ergebnis Integer.
extern CLN_API const cl_I operator+ (const cl_I& x, const cl_I& y);
...
extern CLN_API const cl_I operator- (const cl_I& x);
...
extern CLN_API const cl_I abs (const cl_I& x);
...
extern CLN_API bool equal (const cl_I& x, const cl_I& y);
// equal_hashcode(x) liefert einen equal-invarianten Hashcode für x.
extern CLN_API uint32 equal_hashcode (const cl_I& x);

// compare(x,y) vergleicht zwei Integers x und y.
// Ergebnis: 0 falls x=y, +1 falls x>y, -1 falls x<y.
extern CLN_API cl_signean compare (const cl_I& x, const cl_I& y);
...
// minusp(x) == (< x 0)
extern CLN_API bool minusp (const cl_I& x);

// plusp(x) == (> x 0)
extern CLN_API bool plusp (const cl_I& x);

// zerop(x) stellt fest, ob ein Integer = 0 ist.
extern CLN_API bool zerop (const cl_I& x);
...
extern CLN_API const cl_I ldb (const cl_I& n, const cl_byte& b);
...
extern CLN_API bool ldb_test (const cl_I& n, const cl_byte& b);

// (MASK-FIELD byte n), wo n ein Integer ist.
extern CLN_API const cl_I mask_field (const cl_I& n, const cl_byte& b);

// (DEPOSIT-FIELD newbyte byte n), wo n und newbyte Integers sind.
extern CLN_API const cl_I deposit_field (const cl_I& newbyte, const cl_I& n, const cl_byte& b);

// (DPB newbyte byte n), wo n und newbyte Integers sind.
extern CLN_API const cl_I dpb (const cl_I& newbyte, const cl_I& n, const cl_byte& b);
...
extern CLN_API const cl_I square (const cl_I& x);

// (EXPT x y), wo x Integer, y Integer >0 ist.
extern CLN_API const cl_I expt_pos (const cl_I& x, uintL y);
extern CLN_API const cl_I expt_pos (const cl_I& x, const cl_I& y);

// Fakultät (! n), wo n Fixnum >=0 ist. Ergebnis Integer.
extern CLN_API const cl_I factorial (uintL n);

// Double factorial (!! n), with n Fixnum >=0.  Returns integer.
extern CLN_API const cl_I doublefactorial (uintL n);

// Binomialkoeffizient (n \choose k) = n! / k! (n-k)!, wo n,k >= 0 sind.
extern CLN_API const cl_I binomial (uintL n, uintL k);
...
// < ergebnis: Quotient x/y, ein Integer >=0
  extern CLN_API const cl_I exquopos (const cl_I& x, const cl_I& y);
...
// < ergebnis: Quotient x/y, ein Integer
  extern CLN_API const cl_I exquo (const cl_I& x, const cl_I& y);
...
// mod(x,y) = (mod x y), wo x,y Integers sind.
  extern CLN_API const cl_I mod (const cl_I& x, const cl_I& y);

// rem(x,y) = (rem x y), wo x,y Integers sind.
  extern CLN_API const cl_I rem (const cl_I& x, const cl_I& y);
...
// < q,r: Quotient q, Rest r
  extern CLN_API const cl_I_div_t floor2 (const cl_I& x, const cl_I& y);
  extern CLN_API const cl_I floor1 (const cl_I& x, const cl_I& y);
...
// > x,y: Integers
// < q,r: Quotient q, Rest r
  extern CLN_API const cl_I_div_t ceiling2 (const cl_I& x, const cl_I& y);
  extern CLN_API const cl_I ceiling1 (const cl_I& x, const cl_I& y);
...
// > x,y: Integers
// < q,r: Quotient q, Rest r
  extern CLN_API const cl_I_div_t truncate2 (const cl_I& x, const cl_I& y);
  extern CLN_API const cl_I truncate1 (const cl_I& x, const cl_I& y);
...
// > x,y: Integers
// < q,r: Quotient q, Rest r
  extern CLN_API const cl_I_div_t round2 (const cl_I& x, const cl_I& y);
  extern CLN_API const cl_I round1 (const cl_I& x, const cl_I& y);
...
// < ergebnis: (gcd a b), ein Integer >=0
  extern CLN_API const cl_I gcd (const cl_I& a, const cl_I& b);
  extern CLN_API uintV gcd (uintV a, uintV b);

// Liefert den ggT zweier Integers samt Beifaktoren.
// g = xgcd(a,b,&u,&v)
// > a,b: zwei Integers
// < u, v, g: Integers mit u*a+v*b = g >= 0
  extern CLN_API const cl_I xgcd (const cl_I& a, const cl_I& b, cl_I* u, cl_I* v);
...
// < ergebnis: (lcm a b), ein Integer >=0
  extern CLN_API const cl_I lcm (const cl_I& a, const cl_I& b);
...
// < ergebnis: true falls x Quadratzahl, false sonst
  extern CLN_API bool isqrt (const cl_I& x, cl_I* w);
...
// < ergebnis: true      ..................., false sonst
  extern CLN_API bool sqrtp (const cl_I& x, cl_I* w);
...
// < ergebnis: true            ........................, false sonst
  extern CLN_API bool rootp (const cl_I& x, uintL n, cl_I* w);
  extern CLN_API bool rootp (const cl_I& x, const cl_I& n, cl_I* w);

// max(x,y) liefert (max x y), wo x und y ganze Zahlen sind.
extern CLN_API const cl_I max (const cl_I& x, const cl_I& y);

// min(x,y) liefert (min x y), wo x und y ganze Zahlen sind.
extern CLN_API const cl_I min (const cl_I& x, const cl_I& y);

// signum(x) liefert (signum x), wo x eine ganze Zahl ist.
extern CLN_API const cl_I signum (const cl_I& x);
...
extern CLN_API const cl_I mul_10_plus_x (const cl_I& y, unsigned char x);
...
extern CLN_API const cl_I cl_recip2adic (uintL n, const cl_I& x);
...
extern CLN_API const cl_I cl_div2adic (uintL n, const cl_I& x, const cl_I& y);
...
extern CLN_API float float_approx (const cl_I& x);

// Konversion zu einem C "double".
extern CLN_API double double_approx (const cl_I& x);


// random_I(randomstate,n) liefert zu einem Integer n>0 ein zufälliges
// Integer x mit 0 <= x < n.
// > randomstate: ein Random-State, wird verändert
extern CLN_API const cl_I random_I (random_state& randomstate, const cl_I& n);
...
// > randomstate: ein Random-State, wird verändert
extern CLN_API const cl_I testrandom_I (random_state& randomstate);
...
extern CLN_API cl_class cl_class_fixnum;
extern CLN_API cl_class cl_class_bignum;
CL_FORCE_LINK(cl_I_classes_dummy, cl_class_fixnum)


// Debugging support.
#ifdef CL_DEBUG
extern CLN_API int cl_I_debug_module;
