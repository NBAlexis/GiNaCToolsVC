...
class CLN_API cl_univpoly_ring : public cl_ring {
public:
	// Default constructor.
	cl_univpoly_ring ();
...
class CLN_API _cl_UP /* cf. _cl_ring_element */ {
public:
...
class CLN_API cl_UP /* cf. cl_ring_element */ : public _cl_UP {
protected:
...
struct CLN_API _cl_univpoly_setops /* cf. _cl_ring_setops */ {
	// print
...
struct CLN_API _cl_univpoly_addops /* cf. _cl_ring_addops */ {
	// 0
...
struct CLN_API _cl_univpoly_mulops /* cf. _cl_ring_mulops */ {
	// 1
...
class CLN_API cl_heap_univpoly_ring /* cf. cl_heap_ring */ : public cl_heap {
...
extern CLN_API const cl_univpoly_ring find_univpoly_ring (const cl_ring& r);

// Lookup or create a univariate polynomial ring with a named variable over r.
extern CLN_API const cl_univpoly_ring find_univpoly_ring (const cl_ring& r, const cl_symbol& varname);

class CLN_API cl_UP_init_helper
{
	static int count;
public:
	cl_UP_init_helper();
...
class CLN_API cl_UP_no_ring_init_helper
{
	static int count;
public:
...
template <class T> class CLN_TEMPLATE cl_univpoly_specialized_ring;
template <class T> class CLN_TEMPLATE cl_UP_specialized;
template <class T> class CLN_TEMPLATE cl_heap_univpoly_specialized_ring;

template <class T>
class CLN_TEMPLATE cl_univpoly_specialized_ring : public cl_univpoly_ring {
public:
	// Default constructor.
