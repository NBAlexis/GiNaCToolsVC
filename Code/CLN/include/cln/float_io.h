...
//    Exponenten-Ziffer)
// < ergebnis: Float
extern CLN_API const cl_F read_float (unsigned int base, float_format_t prec,
...
extern CLN_API const cl_F read_float (const cl_read_flags& flags, const char * string, const char * string_limit, const char * * end_of_parse);
extern CLN_API const cl_F read_float (std::istream& stream, const cl_read_flags& flags);
...
extern CLN_API void print_float (std::ostream& stream, const cl_print_number_flags& flags, const cl_F& z);
extern CLN_API void print_float (std::ostream& stream, const cl_print_real_flags& flags, const cl_F& z);
extern CLN_API void print_float (std::ostream& stream, const cl_print_float_flags& flags, const cl_F& z);

// Gibt ein Float binär (sehr primitiv) aus.
// print_float_binary(stream,z);
// > z: Float
// > stream: Stream
extern CLN_API void print_float_binary (std::ostream& stream, const cl_F& z);
