...
extern CLN_API const cl_RA read_rational (unsigned int base,
...
extern CLN_API const cl_RA read_rational (const cl_read_flags& flags, const char * string, const char * string_limit, const char * * end_of_parse);
extern CLN_API const cl_RA read_rational (std::istream& stream, const cl_read_flags& flags);

// Documented input functions

extern CLN_API cl_read_flags cl_RA_read_flags;
...
// > base: Basis (>=2, <=36)
// > stream: Stream
extern CLN_API void print_rational (std::ostream& stream, unsigned int base, const cl_RA& z);
...
extern CLN_API void print_rational (std::ostream& stream, const cl_print_flags& flags, const cl_RA& z);
extern CLN_API void print_rational (std::ostream& stream, const cl_print_number_flags& flags, const cl_RA& z);
extern CLN_API void print_rational (std::ostream& stream, const cl_print_real_flags& flags, const cl_RA& z);
extern CLN_API void print_rational (std::ostream& stream, const cl_print_rational_flags& flags, const cl_RA& z);
