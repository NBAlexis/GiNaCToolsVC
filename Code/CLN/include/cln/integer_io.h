...
// < ergebnis: Integer
extern CLN_API const cl_I read_integer (unsigned int base,
...
extern CLN_API const cl_I read_integer (const cl_read_flags& flags, const char * string, const char * string_limit, const char * * end_of_parse);
extern CLN_API const cl_I read_integer (std::istream& stream, const cl_read_flags& flags);

// Documented input functions
extern CLN_API cl_read_flags cl_I_read_flags;
...
extern CLN_API char * cl_decimal_string (const cl_I& x);
...
// > base: Basis (>=2, <=36)
// > stream: Stream
extern CLN_API void print_integer (std::ostream& stream, unsigned int base, const cl_I& z);
// Dasselbe als String. Mit malloc_hook() alloziert, mit free_hook() freizugeben.
extern CLN_API char * print_integer_to_string (unsigned int base, const cl_I& z);
...
extern CLN_API void print_integer (std::ostream& stream, const cl_print_number_flags& flags, const cl_I& z);
extern CLN_API void print_integer (std::ostream& stream, const cl_print_real_flags& flags, const cl_I& z);
extern CLN_API void print_integer (std::ostream& stream, const cl_print_rational_flags& flags, const cl_I& z);
