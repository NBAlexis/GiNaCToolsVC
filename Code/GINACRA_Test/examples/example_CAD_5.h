...
int example_CAD_5main()
{
    ...
    //    RealAlgebraicNumberIR a( UnivariatePolynomial(-3+x, x), OpenInterval(93/32, 193/64));
    //    RealAlgebraicNumberIR a( UnivariatePolynomial( -3 + x, x ), OpenInterval( numeric( 93, 32 ), numeric( 193, 64 )), false);
    //    cout << a << ".sample=" << a.sampleValue() << endl;
