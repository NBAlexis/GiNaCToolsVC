...
class GINAC_API NAME##_SERIAL { public: static unsigned serial; }; \
...
class GINAC_API function_options
{
...
class GINAC_API do_taylor {};


/** The class function is used to implement builtin functions like sin, cos...
	and user defined functions */
class GINAC_API function : public exprseq
{
