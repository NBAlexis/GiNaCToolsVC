...
class GINAC_API ncmul : public exprseq
{
	GINAC_DECLARE_REGISTERED_CLASS(ncmul, exprseq)

    GINAC_API friend class power;
    GINAC_API friend ex reeval_ncmul(const exvector & v);
    GINAC_API friend ex hold_ncmul(const exvector & v);
