...
public:
	 ...
	 *  @see get_properties */
	struct GINAC_API property_info {
		property_info() {}
...
class GINAC_API unarchive_table_t
{
	static int usecount;
...
class GINAC_API classname ## _unarchiver					\
{								\
	static int usecount;					\
public:								\
...
class GINAC_API archive
{
    GINAC_API friend std::ostream &operator<<(std::ostream &os, const archive &ar);
    GINAC_API friend std::istream &operator>>(std::istream &is, archive &ar);
...
GINAC_API std::ostream &operator<<(std::ostream &os, const archive &ar);
GINAC_API std::istream &operator>>(std::istream &is, archive &ar);
