...
struct GINAC_API return_type_t
{
...
class GINAC_API registered_class_options {
public:
...
class GINAC_API ciregistered_class_options : class_info<registered_class_options> {}; //4251
