...
class GINAC_API sy_is_less;
class GINAC_API sy_swap;
...
class GINAC_API symmetry : public basic
{
...
GINAC_API const symmetry & not_symmetric();
GINAC_API const symmetry & symmetric2();
GINAC_API const symmetry & symmetric3();
GINAC_API const symmetry & symmetric4();
GINAC_API const symmetry & antisymmetric2();
GINAC_API const symmetry & antisymmetric3();
GINAC_API const symmetry & antisymmetric4();
...
GINAC_API ex symmetrize(const ex & e, exvector::const_iterator first, exvector::const_iterator last);
...
GINAC_API ex antisymmetrize(const ex & e, exvector::const_iterator first, exvector::const_iterator last);
 ...
 *  (symbols, indices). */
GINAC_API ex symmetrize_cyclic(const ex & e, exvector::const_iterator first, exvector::const_iterator last);
