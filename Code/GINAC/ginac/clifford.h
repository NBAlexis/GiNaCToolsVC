...
class GINAC_API clifford : public indexed
{
...
class GINAC_API diracone : public tensor
{
...
class GINAC_API cliffordunit : public tensor
{
...
class GINAC_API diracgamma : public cliffordunit
{
 ...
 *  all other gammas. */
class GINAC_API diracgamma5 : public tensor
{
 ...
 *  1/2 (1-gamma5). */
class GINAC_API diracgammaL : public tensor
{
...
/** This class represents the Dirac gammaL object which behaves like
 *  1/2 (1+gamma5). */
class GINAC_API diracgammaR : public tensor
{
...
GINAC_API ex dirac_ONE(unsigned char rl = 0);
...
GINAC_API ex clifford_unit(const ex & mu, const ex & metr, unsigned char rl = 0);
...
GINAC_API ex dirac_gamma(const ex & mu, unsigned char rl = 0);

/** Create a Dirac gamma5 object.
 *
 *  @param rl Representation label
 *  @return newly constructed object */
GINAC_API ex dirac_gamma5(unsigned char rl = 0);

/** Create a Dirac gammaL object.
 *
 *  @param rl Representation label
 *  @return newly constructed object */
GINAC_API ex dirac_gammaL(unsigned char rl = 0);

/** Create a Dirac gammaR object.
 *
 *  @param rl Representation label
 *  @return newly constructed object */
GINAC_API ex dirac_gammaR(unsigned char rl = 0);
 ...
 *  @param rl Representation label */
GINAC_API ex dirac_slash(const ex & e, const ex & dim, unsigned char rl = 0);
...
GINAC_API ex dirac_trace(const ex & e, const std::set<unsigned char> & rls, const ex & trONE = 4);
 ...
 *  @param trONE Expression to be returned as the trace of the unit matrix */
GINAC_API ex dirac_trace(const ex & e, const lst & rll, const ex & trONE = 4);
 ...
 *  @param rl Representation label
 *  @param trONE Expression to be returned as the trace of the unit matrix */
GINAC_API ex dirac_trace(const ex & e, unsigned char rl = 0, const ex & trONE = 4);
...
GINAC_API ex canonicalize_clifford(const ex & e);

/** Automorphism of the Clifford algebra, simply changes signs of all
 *  clifford units. */
GINAC_API ex clifford_prime(const ex & e);

/** An auxillary function performing clifford_star() and clifford_bar().*/
GINAC_API ex clifford_star_bar(const ex & e, bool do_bar, unsigned options);
...
GINAC_API ex remove_dirac_ONE(const ex & e, unsigned char rl = 0, unsigned options = 0);
...
GINAC_API int clifford_max_label(const ex & e, bool ignore_ONE = false);

/** Calculation of the norm in the Clifford algebra. */
GINAC_API ex clifford_norm(const ex & e);

/** Calculation of the inverse in the Clifford algebra. */
GINAC_API ex clifford_inverse(const ex & e);
...
GINAC_API ex lst_to_clifford(const ex & v, const ex & mu,  const ex & metr, unsigned char rl = 0);
GINAC_API ex lst_to_clifford(const ex & v, const ex & e);
...
GINAC_API lst clifford_to_lst(const ex & e, const ex & c, bool algebraic=true);
...
GINAC_API ex clifford_moebius_map(const ex & a, const ex & b, const ex & c, const ex & d, const ex & v, const ex & G, unsigned char rl = 0);
 ...
 *  @param rl Representation label 
 *  @return List of components of the transformed vector*/
GINAC_API ex clifford_moebius_map(const ex & M, const ex & v, const ex & G, unsigned char rl = 0);
