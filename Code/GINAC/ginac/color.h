...
class GINAC_API color : public indexed
{
...
class GINAC_API su3one : public tensor
{
...
class GINAC_API su3t : public tensor
{
 ...
 *  constants. */
class GINAC_API su3f : public tensor
{
...
class GINAC_API su3d : public tensor
{
...
GINAC_API ex color_ONE(unsigned char rl = 0);
...
GINAC_API ex color_T(const ex & a, unsigned char rl = 0);
...
GINAC_API ex color_f(const ex & a, const ex & b, const ex & c);
 ...
 *  @param c Third index
 *  @return newly constructed structure constant */
GINAC_API ex color_d(const ex & a, const ex & b, const ex & c);

/** This returns the linear combination d.a.b.c+I*f.a.b.c. */
GINAC_API ex color_h(const ex & a, const ex & b, const ex & c);
...
GINAC_API ex color_trace(const ex & e, const std::set<unsigned char> & rls);

/** Calculate color traces over the specified list of representation labels.
 *
 *  @param e Expression to take the trace of
 *  @param rll List of representation labels */
GINAC_API ex color_trace(const ex & e, const lst & rll);
 ...
 *  @param e Expression to take the trace of
 *  @param rl Representation label */
GINAC_API ex color_trace(const ex & e, unsigned char rl = 0);
