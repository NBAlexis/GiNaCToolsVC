...
class GINAC_API expand_options {
public:
	enum {
...
class GINAC_API series_options {
public:
	enum {
...
class GINAC_API determinant_algo {
public:
	enum {
 ...
 *  @see remember_table */
class GINAC_API remember_strategies {
public:
	enum {
...
class GINAC_API factor_options {
public:
	enum {
