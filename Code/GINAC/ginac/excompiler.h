 ...
 */
extern GINAC_API void compile_ex(const ex& expr, const symbol& sym, FUNCP_1P& fp, const std::string filename = "");
 ...
 * supplied, these intermediate files will not be deleted
 */
extern GINAC_API void compile_ex(const ex& expr, const symbol& sym1, const symbol& sym2, FUNCP_2P& fp, const std::string filename = "");
 ...
 * supplied, these intermediate files will not be deleted
 */
extern GINAC_API void compile_ex(const lst& exprs, const lst& syms, FUNCP_CUBA& fp, const std::string filename = "");
 ...
 * @param fp Returned function pointer
 */
extern GINAC_API void link_ex(const std::string filename, FUNCP_1P& fp);
 ...
 * @param fp Returned function pointer
 */
extern GINAC_API void link_ex(const std::string filename, FUNCP_2P& fp);
 ...
 * @param fp Returned function pointer
 */
extern GINAC_API void link_ex(const std::string filename, FUNCP_CUBA& fp);
 ...
 */
extern GINAC_API void unlink_ex(const std::string filename);
