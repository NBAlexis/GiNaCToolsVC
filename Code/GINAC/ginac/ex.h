...
namespace GiNaC {
  ...
  extern GINAC_API const class ex _ex0;
#endif
...
class GINAC_API scalar_products;
class GINAC_API const_iterator;
class GINAC_API const_preorder_iterator;
class GINAC_API const_postorder_iterator;
...
class GINAC_API const_iterator : public std::iterator<std::random_access_iterator_tag, ex, ptrdiff_t, const ex *, const ex &> {
	friend class ex;
...
class GINAC_API const_preorder_iterator : public std::iterator<std::forward_iterator_tag, ex, ptrdiff_t, const ex *, const ex &> {
public:
...
class GINAC_API const_postorder_iterator : public std::iterator<std::forward_iterator_tag, ex, ptrdiff_t, const ex *, const ex &> {
public:
...
struct GINAC_API ex_is_less {
	bool operator() (const ex &lh, const ex &rh) const { return lh.compare(rh) < 0; }
};

struct GINAC_API ex_is_equal {
	bool operator() (const ex &lh, const ex &rh) const { return lh.is_equal(rh); }
};

struct GINAC_API op0_is_equal {
	bool operator() (const ex &lh, const ex &rh) const { return lh.op(0).is_equal(rh.op(0)); }
};

struct GINAC_API ex_swap {
	void operator() (ex &lh, ex &rh) const { lh.swap(rh); }
};

// Make it possible to print exvectors and exmaps
GINAC_API std::ostream & operator<<(std::ostream & os, const exvector & e);
GINAC_API std::ostream & operator<<(std::ostream & os, const exset & e);
GINAC_API std::ostream & operator<<(std::ostream & os, const exmap & e);
