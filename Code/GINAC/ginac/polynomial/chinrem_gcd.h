...
extern GINAC_API ex chinrem_gcd(const ex& A_, const ex& B_, const exvector& vars);
extern GINAC_API ex chinrem_gcd(const ex& A, const ex& B);

struct GINAC_API chinrem_gcd_failed
{
