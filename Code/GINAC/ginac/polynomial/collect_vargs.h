 ...
 */
extern GINAC_API ex lcoeff_wrt(ex e, const exvector& x);
 ...
 */
extern GINAC_API exp_vector_t degree_vector(ex e, const exvector& vars);

/**
 * Leading coefficient c \in R (where R = Z or Z_p) of a multivariate
 * polynomial e \in R[x_0, \ldots, x_n]
 */
extern GINAC_API cln::cl_I integer_lcoeff(const ex& e, const exvector& vars);
