...
class GINAC_API tensor : public basic
{
...
class GINAC_API tensdelta : public tensor
{
...
class GINAC_API tensmetric : public tensor
{
...
class GINAC_API minkmetric : public tensmetric
{
...
class GINAC_API spinmetric : public tensmetric
{
...
class GINAC_API tensepsilon : public tensor
{
...
extern GINAC_API ex delta_tensor(const ex & i1, const ex & i2);
...
extern GINAC_API ex metric_tensor(const ex & i1, const ex & i2);
...
extern GINAC_API ex lorentz_g(const ex & i1, const ex & i2, bool pos_sig = false);
...
extern GINAC_API ex spinor_metric(const ex & i1, const ex & i2);
...
extern GINAC_API ex epsilon_tensor(const ex & i1, const ex & i2);
 ...
 *  @return newly constructed epsilon tensor */
extern GINAC_API ex epsilon_tensor(const ex & i1, const ex & i2, const ex & i3);
 ...
 *  @return newly constructed epsilon tensor */
extern GINAC_API ex lorentz_eps(const ex & i1, const ex & i2, const ex & i3, const ex & i4, bool pos_sig = false);
