...
class GINAC_API idx : public basic
{
...
class GINAC_API varidx : public idx
{
 ...
 *  indices. */
class GINAC_API spinidx : public varidx
{
...
extern GINAC_API bool is_dummy_pair(const idx & i1, const idx & i2);

/** Check whether two expressions form a dummy index pair. */
extern GINAC_API bool is_dummy_pair(const ex & e1, const ex & e2);
...
extern GINAC_API void find_free_and_dummy(exvector::const_iterator it, exvector::const_iterator itend, exvector & out_free, exvector & out_dummy);
...
extern GINAC_API ex minimal_dim(const ex & dim1, const ex & dim2);
