...
class GINAC_API _numeric_digits
{
// member functions
public:
	_numeric_digits();
...
class GINAC_API pole_error : public std::domain_error {
public:
...
class GINAC_API numeric : public basic
{
...
public:
	...
	numeric(long long numer, long long denom);
	numeric(double d);
	numeric(const char *);
...
public:
	...
	const numeric & operator=(long long i);
	const numeric & operator=(unsigned long long i);
...
extern GINAC_API const numeric I;
extern GINAC_API _numeric_digits Digits;

// global functions

GINAC_API const numeric exp(const numeric &x);
GINAC_API const numeric log(const numeric &x);
GINAC_API const numeric sin(const numeric &x);
GINAC_API const numeric cos(const numeric &x);
GINAC_API const numeric tan(const numeric &x);
GINAC_API const numeric asin(const numeric &x);
GINAC_API const numeric acos(const numeric &x);
GINAC_API const numeric atan(const numeric &x);
GINAC_API const numeric atan(const numeric &y, const numeric &x);
GINAC_API const numeric sinh(const numeric &x);
GINAC_API const numeric cosh(const numeric &x);
GINAC_API const numeric tanh(const numeric &x);
GINAC_API const numeric asinh(const numeric &x);
GINAC_API const numeric acosh(const numeric &x);
GINAC_API const numeric atanh(const numeric &x);
GINAC_API const numeric Li2(const numeric &x);
GINAC_API const numeric zeta(const numeric &x);
GINAC_API const numeric lgamma(const numeric &x);
GINAC_API const numeric tgamma(const numeric &x);
GINAC_API const numeric psi(const numeric &x);
GINAC_API const numeric psi(const numeric &n, const numeric &x);
GINAC_API const numeric factorial(const numeric &n);
GINAC_API const numeric doublefactorial(const numeric &n);
GINAC_API const numeric binomial(const numeric &n, const numeric &k);
GINAC_API const numeric bernoulli(const numeric &n);
GINAC_API const numeric fibonacci(const numeric &n);
GINAC_API const numeric isqrt(const numeric &x);
GINAC_API const numeric sqrt(const numeric &x);
GINAC_API const numeric abs(const numeric &x);
GINAC_API const numeric mod(const numeric &a, const numeric &b);
GINAC_API const numeric smod(const numeric &a, const numeric &b);
GINAC_API const numeric irem(const numeric &a, const numeric &b);
GINAC_API const numeric irem(const numeric &a, const numeric &b, numeric &q);
GINAC_API const numeric iquo(const numeric &a, const numeric &b);
GINAC_API const numeric iquo(const numeric &a, const numeric &b, numeric &r);
GINAC_API const numeric gcd(const numeric &a, const numeric &b);
GINAC_API const numeric lcm(const numeric &a, const numeric &b);
...
GINAC_API ex PiEvalf();
GINAC_API ex EulerEvalf();
GINAC_API ex CatalanEvalf();
