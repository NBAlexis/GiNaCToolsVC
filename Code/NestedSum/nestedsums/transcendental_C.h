...
namespace nestedsums {
   ...
   *
   */
  class NESTEDSUMS_API transcendental_sum_type_C : public GiNaC::basic
    {
      GINAC_DECLARE_REGISTERED_CLASS(transcendental_sum_type_C, GiNaC::basic)

	// ctors
    public:
      transcendental_sum_type_C(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l, const GiNaC::ex & v, const GiNaC::ex & ss, 
...
GINAC_DECLARE_UNARCHIVER(transcendental_sum_type_C);
   ...
   *
   */
inline GiNaC::ex create_transcendental_sum_type_C(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l, const GiNaC::ex & v, const GiNaC::ex & ss, 
				     const GiNaC::ex & eps, int o, int f)
  {
    return (new transcendental_sum_type_C(nn,i,l,v,ss,eps,o,f))->setflag(GiNaC::status_flags::dynallocated);
  }
   ...
   *
   */
inline GiNaC::ex create_transcendental_sum_type_C_and_set_gammas(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l, 
				     ...
				     const GiNaC::ex & eps, int o, int f)
  {
    ...
    return (new transcendental_sum_type_C(nn,i,l,new_v,ss,eps,o,f))->setflag(GiNaC::status_flags::dynallocated);
  }

NESTEDSUMS_API GiNaC::ex create_transcendental_sum_type_C_and_expand(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l,
					       const GiNaC::ex & v, const GiNaC::ex & ss, 
