...
/** @file transc_fct_C.h
 *
 * Interface to transcendental_fct_type_C
 *
 */
...
namespace nestedsums {
  ...
  /// The class transcendental_fct_type_C provides an interface
  /// to the class transcendental_sum_type_C.
  /**
   *
   *  The definition is 
   *  \f[
   ...
   *
   */
  class NESTEDSUMS_API transcendental_fct_type_C : public GiNaC::basic
    {
      GINAC_DECLARE_REGISTERED_CLASS(transcendental_fct_type_C, GiNaC::basic)

	// ctors
    public:
      transcendental_fct_type_C(const GiNaC::ex & xx1, const GiNaC::ex & xx2, const GiNaC::ex & ii_num, const GiNaC::ex & ii_denom, 
...
GINAC_DECLARE_UNARCHIVER(transcendental_fct_type_C);
   ...
   *
   */
inline GiNaC::ex create_transcendental_fct_type_C(const GiNaC::ex & xx1, const GiNaC::ex & xx2, const GiNaC::ex & ii_num, const GiNaC::ex & ii_denom,
					   const GiNaC::ex & iijj_num, const GiNaC::ex & iijj_denom, 
					   const GiNaC::ex & pp_num, const GiNaC::ex & pp_denom)
  {
    return (new transcendental_fct_type_C(xx1,xx2,ii_num,ii_denom,iijj_num,iijj_denom,pp_num,pp_denom)
...
inline GiNaC::ex create_transcendental_fct_type_C(const GiNaC::ex & xx1, const GiNaC::ex & xx2, const GiNaC::ex & ii_num, const GiNaC::ex & ii_denom, 
					   ...
					   const GiNaC::ex & pp_num, const GiNaC::ex & pp_denom, const GiNaC::ex & eps, int o, int f)
  {
    return (new transcendental_fct_type_C(xx1,xx2,ii_num,ii_denom,iijj_num,iijj_denom,pp_num,pp_denom,eps,o,f)
	    )->setflag(GiNaC::status_flags::dynallocated);
  }
