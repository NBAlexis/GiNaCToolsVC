...
/** @file transc_fct_B.cc
 *
 * Implementation of transcendental_fct_type_B
 *
 */
...
GINAC_IMPLEMENT_REGISTERED_CLASS(transcendental_fct_type_B, basic)

GINAC_BIND_UNARCHIVER(transcendental_fct_type_B);


  transcendental_fct_type_B::transcendental_fct_type_B() : inherited(),
  ...
  void transcendental_fct_type_B::archive(archive_node &node) const
  {
  ...
  void transcendental_fct_type_B::read_archive(const archive_node &node, lst &sym_lst)
  {
  ...
  int transcendental_fct_type_B::compare_same_type(const basic &other) const
  {
    const transcendental_fct_type_B &o = static_cast<const transcendental_fct_type_B &>(other);
  ...
  // other ctors
  transcendental_fct_type_B::transcendental_fct_type_B(const ex & xx1, const ex & xx2, const ex & ii_num, const ex & ii_denom, 
  ...
  unsigned transcendental_fct_type_B::calchash(void) const
    {
  ...
  void transcendental_fct_type_B::print(const print_context & c, unsigned level) const
  {
   ...
   *
   */
  ex transcendental_fct_type_B::eval() const
  {
#ifdef _DEBUG
    time_t time_start;
    time_t time_end;
	...
	time(&time_end);
	std::cout << "transcendental_fct_type_B, part 1, time in seconds : " << difftime(time_end,time_start) << std::endl;
#endif // def _DEBUG
	...
	// measuring time end here
	time(&time_end);
	std::cout << "transcendental_fct_type_B, part 2, time in seconds : " << difftime(time_end,time_start) << std::endl;
#endif // def _DEBUG
	...
	// measuring time end here
	time(&time_end);
	std::cout << "transcendental_fct_type_B, part 3, time in seconds : " << difftime(time_end,time_start) << std::endl;
#endif // def _DEBUG
	...
	// measuring time end here
	time(&time_end);
	std::cout << "transcendental_fct_type_B, part 4, time in seconds : " << difftime(time_end,time_start) << std::endl;
#endif // def _DEBUG
...
#ifdef _DEBUG
	time(&time_end);
	std::cout << "transcendental_fct_type_B, part 5, time in seconds : " << difftime(time_end,time_start) << std::endl;
	time(&time_start);
#endif // def _DEBUG
	...
	// measuring time end here
	time(&time_end);
	std::cout << "transcendental_fct_type_B, part 6, time in seconds : " << difftime(time_end,time_start) << std::endl;
	time(&time_start);
#endif // def _DEBUG
	...
	// measuring time end here
	time(&time_end);
	std::cout << "transcendental_fct_type_B, part 7, time in seconds : " << difftime(time_end,time_start) << std::endl;
#endif // def _DEBUG
   ...
   *
   */
  ex transcendental_fct_type_B::eval_ncmul(const exvector & v) const
  {
  ...
  ex transcendental_fct_type_B::derivative(const symbol & s) const
  {
    return 0;
  }

  ex transcendental_fct_type_B::subs(const exmap & m, unsigned options) const
  {
    exmap::const_iterator it = m.find(*this);
    if (it != m.end())
        return it->second;

    return create_transcendental_fct_type_B(x1.subs(m,options),x2.subs(m,options),
   ...
   *
   */
  ex transcendental_fct_type_B::set_expansion(const ex & eps, int o) const
  {
    transcendental_fct_type_B* res = new transcendental_fct_type_B(x1,x2,i_num,i_denom,
   ...
   *
   */
  ex transcendental_fct_type_B::shift_plus_one(void) const
  {
    int k;
    ...
    return x1*x2*create_transcendental_fct_type_B(x1,x2,
