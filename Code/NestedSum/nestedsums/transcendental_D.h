...
namespace nestedsums {
  ...
  /// The class transcendental_sum_type_D involves a conjugation and 
  /// may contain \f$i\f$ and \f$(n-i)\f$.
  /**
   *
   *  The definition is 
   *  \f[
   ...
   * In addition \f$c\f$ is non-negative or \f$c \ge o \f$
   * Simmilar, \f$c'\f$ is non-negative or \f$c' \ge o' \f$
   *
   * Note that the upper summation limit is \f$(n-1)\f$.
   * The upper summation limit should not be infinity.
   *
   */
  class NESTEDSUMS_API transcendental_sum_type_D : public GiNaC::basic
    {
      GINAC_DECLARE_REGISTERED_CLASS(transcendental_sum_type_D, GiNaC::basic)

	// ctors
    public:
      transcendental_sum_type_D(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l, const GiNaC::ex & lr, 
...
GINAC_DECLARE_UNARCHIVER(transcendental_sum_type_D);
   ...
   *
   */
inline GiNaC::ex create_transcendental_sum_type_D(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l, const GiNaC::ex & lr, 
				    const GiNaC::ex & v, const GiNaC::ex & vr, const GiNaC::ex & ss, const GiNaC::ex & ssr, 
				    const GiNaC::ex & eps, int o, int f)
  {
    return (new transcendental_sum_type_D(nn,i,l,lr,v,vr,ss,ssr,eps,o,f))->setflag(GiNaC::status_flags::dynallocated);
  }
   ...
   *
   */
inline GiNaC::ex create_transcendental_sum_type_D_and_set_gammas(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l, const GiNaC::ex & lr, 
				    const GiNaC::ex & v, const GiNaC::ex & vr, const GiNaC::ex & ss, const GiNaC::ex & ssr, 
				    const GiNaC::ex & eps, int o, int f)
  {
    ...
    return (new transcendental_sum_type_D(nn,i,l,lr,new_v,new_vr,ss,ssr,eps,o,f))->setflag(GiNaC::status_flags::dynallocated);
  }

NESTEDSUMS_API GiNaC::ex create_transcendental_sum_type_D_and_expand(const GiNaC::ex & nn, const GiNaC::ex & i, const GiNaC::ex & l, const GiNaC::ex & lr,
					       const GiNaC::ex & v, const GiNaC::ex & vr, const GiNaC::ex & ss, const GiNaC::ex & ssr, 
